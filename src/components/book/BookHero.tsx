  ...
  <section className="bg-charcoal py-24 lg:py-36">
    <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
      <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
        <motion.div initial="hidden" animate="visible" variants={fade} className="text-center md:text-left">
          ...
          <p className="mt-6 font-body text-xl text-cream/80 max-w-[680px] leading-relaxed">
          ...
          <a href={STRIPE_URL}>
            <Button
              size="lg"
              className="mt-10 bg-gold text-charcoal hover:bg-gold/90 font-body font-semibold text-base px-10 py-6 h-auto w-full md:w-auto"
            >
        ...
        >
          <img src={bookMockup} alt="Cyber Curiosity book cover" className="rounded-lg shadow-2xl max-w-sm w-full" />
        </motion.div>
      </div>
